"""Tests for the ORLEN Paczka deliveries calendar."""
from datetime import datetime, timezone
from unittest.mock import MagicMock

from custom_components.orlen_paczka.calendar import ORLENPaczkaDeliveriesCalendar
...
def _cal(data):
    return ORLENPaczkaDeliveriesCalendar(_coordinator(data), _entry())
...
def test_pickup_sets_location():
    cal = _cal([_parcel("A", planned_from="2099-01-01T10:00:00Z", pickup=True, pickup_point="ORLEN Paczka Shop")])
    assert cal._events()[0].location == "ORLEN Paczka Shop"
